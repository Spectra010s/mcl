...
export const metadata: Metadata = {
  title: 'About Us',
  description:
    'Learn about the mission behind My Campus Library and how we support academic excellence.',
}
          ...
          <Card className="mb-8 border-primary/20">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                ...
                We are on a mission to break down educational barriers and create a world where
                every student has the tools they need to succeed. Our goal is to transform the way
                knowledge is shared and accessed, making quality education a right, not a privilege.
              </p>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <p className="text-muted-foreground leading-relaxed">
                We&apos;re creating a dynamic learning ecosystem that supports students at every
                step of their educational journey. We are not just building a library; we&apos;re
                nurturing a global community of passionate learners and educators united by the
          ...
          <Card className="mb-8 border-primary/20">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                ...
                has seamless access to high-quality educational resources. Our platform aims to
                break down barriers to education by creating a global community of learners and
                educators who share knowledge freely and collaboratively.
              </p>
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>
                  To leverage technology in making education more engaging, interactive, and
                  effective
                </li>
                <li>
                  To support lifelong learning by providing resources for continuous skill
                  development
                </li>
                <li>
