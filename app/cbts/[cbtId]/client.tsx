                ...
                <Card className="mb-8">
                    <CardHeader>
                        <div className="flex items-center gap-2 text-muted-foreground mb-2">
                            ...
                            <span>{cbt.courses.course_code}: {cbt.courses.course_title}</span>
                        </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {questions.map((q, index) => (
                            <button
                                ...
                                className={`w-8 h-8 rounded-md text-sm font-medium transition-colors ${index === currentQuestionIndex
                        ...
                        <div className="space-y-3">
                            {currentQuestion.options.map((option, index) => (
                                <button
                                    ...
                                    className={`w-full text-left p-4 rounded-lg border transition-all ${answers[currentQuestion.question_id] === option.id.toString()
        ...
        return (
            <main className="flex-1 max-w-2xl mx-auto px-4 py-12 md:px-6">
                <Card className="text-center">
                    <CardHeader>
                        <div className={`w-20 h-20 mx-auto mb-4 rounded-full flex items-center justify-center ${passed ? 'bg-green-500/20' : 'bg-red-500/20'
                            }`}>
                            {passed ? (
                        ...
                        <CardDescription className="text-lg">
                            {passed
                                ? 'You passed the test!'
                                : `You need ${cbt.passing_score}% to pass.`}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        ...
                        {currentAttempt.time_taken_seconds && (
                            <div className="text-sm text-muted-foreground mb-6">
                                Completed in {Math.floor(currentAttempt.time_taken_seconds / 60)}m {currentAttempt.time_taken_seconds % 60}s
                            </div>
                        )}
            ...
            <main className="flex-1 max-w-4xl mx-auto px-4 py-12 md:px-6">
                ...
                <div className="space-y-6">
                    {reviewData.map((item, index) => (
                        <Card key={index} className={item.is_user_correct ? 'border-green-500/50' : 'border-red-500/50'}>
                            ...
                            <CardContent>
                                <div className="space-y-2">
                                    {item.options.map((option, optIndex) => {
                                        ...
                                        if (isCorrect) {
                                            className += "border-green-500 bg-green-500/10 text-green-700 dark:text-green-400 font-medium"
