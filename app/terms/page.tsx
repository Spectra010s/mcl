...
export const metadata: Metadata = {
  ...
  description:
    'The rules and guidelines for contributing to and using the academic materials on My Campus Library.',
}
          ...
          <div className="bg-white dark:bg-slate-950 rounded-lg p-8 space-y-6 text-foreground">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing the My Campus Library application, you are agreeing to be bound by
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                My Campus Library, even if My Campus Library or an authorized representative has
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                on its website are accurate, complete, or current. My Campus Library may make
